...
import { Rocket, Users, ShieldCheck, ArrowRight, Check, X } from 'lucide-react';
...
export const OnboardingGuide: React.FC<OnboardingGuideProps> = ({ isOpen, onClose, onStartAction }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/80 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden relative mx-4">
          ...
          {step === 1 && (
            <div className="text-center space-y-4 animate-in slide-in-from-right-8 duration-300">
              ...
              <p className="text-slate-500 leading-relaxed">
                Sua plataforma profissional de Business Intelligence para gestão de tráfego e performance. Vamos configurar seu workspace em menos de 1 minuto.
              </p>
            </div>
          )}
